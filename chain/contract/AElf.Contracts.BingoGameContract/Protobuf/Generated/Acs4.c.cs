...
namespace Acs4 {
  ...
  internal static partial class ConsensusContractContainer
  {
    ...
    public class ConsensusContractReferenceState : global::AElf.Sdk.CSharp.State.ContractReferenceState
    {
      internal global::AElf.Sdk.CSharp.State.MethodReference<global::Google.Protobuf.WellKnownTypes.BytesValue, global::Acs4.ConsensusCommand> GetConsensusCommand { get; set; }
      internal global::AElf.Sdk.CSharp.State.MethodReference<global::Google.Protobuf.WellKnownTypes.BytesValue, global::Google.Protobuf.WellKnownTypes.BytesValue> GetConsensusExtraData { get; set; }
      internal global::AElf.Sdk.CSharp.State.MethodReference<global::Google.Protobuf.WellKnownTypes.BytesValue, global::Acs4.TransactionList> GenerateConsensusTransactions { get; set; }
      internal global::AElf.Sdk.CSharp.State.MethodReference<global::Google.Protobuf.WellKnownTypes.BytesValue, global::Acs4.ValidationResult> ValidateConsensusBeforeExecution { get; set; }
      internal global::AElf.Sdk.CSharp.State.MethodReference<global::Google.Protobuf.WellKnownTypes.BytesValue, global::Acs4.ValidationResult> ValidateConsensusAfterExecution { get; set; }
    }
  }
}
#endregion
